...
```bash
sudo weectl extension install https://github.com/aganet/weewx-aganetwx/releases/latest/download/AganetWX-1.8.4.zip
...
```bash
sudo weectl extension install /path/to/AganetWX-1.8.4.zip
```
